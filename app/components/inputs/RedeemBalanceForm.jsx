...
const RedeemBalanceForm = ({ onSubmit }) => {
  const [inputBank, setInputBank] = useState("");
  const [inputAmount, setInputAmount] = useState("");

  const onButtonClick = () => {
    if (!inputBank || !inputAmount) {
      toast.error("Please give proper input");
    } else {
      onSubmit(inputBank, inputAmount);
    }
  };
...
export default RedeemBalanceForm;
